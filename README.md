...
- Rendered QA covers dashboard feature maps and jump links, module brief visibility, official docs links, efficiency habits, multiple terminal challenge flows, Replay, multi-tip Forest state, Plant and Forest cascade scaling, newest-tree marker/count, command palette locked/unlocked behavior, desktop/mobile overflow, and browser console/runtime errors.
