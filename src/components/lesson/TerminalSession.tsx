...
export default function TerminalSession({ script }: { script: SessionLine[] }) {
  ...
  return (
    <div className="flex h-full min-h-[22rem] flex-col bg-terminal font-mono text-[0.82rem] leading-relaxed">
      ...
      <Player key={runId} script={script} reduced={reduced} />
...
function Player({ script, reduced }: { script: SessionLine[]; reduced: boolean }) {
